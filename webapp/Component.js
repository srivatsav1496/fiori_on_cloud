sap.ui.define(
	...
	function(UIComponent){
		return UIComponent.extend("sgtp.app.Component",{
			metadata: {
				manifest: "json"
			},
			init: function(){
			...
			// 		viewName: "sgtp.app.view.View1",
			// 		type: "XML"
			// 	});
			
			// 	var oView2 = new sap.ui.view("idView2",{
			// 		viewName: "sgtp.app.view.View2",
			// 		type: "XML"
			// 	});
			// 	var oEmpty = new sap.ui.view("idEmpty",{
			// 		viewName: "sgtp.app.view.Empty",
			// 		type: "XML"
			// 	});
